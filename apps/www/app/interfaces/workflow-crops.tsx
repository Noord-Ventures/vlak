...
export function SocialCrop() {
  return <Frame icon="image" title="Studio 03" context="Following" footer={<><span>Mara / Print study</span><span>4 comments</span></>}><div className="wf-crop-photo"><img loading="lazy" decoding="async" src="/interfaces/threads/press-sheet-v2.jpg" alt="" /></div></Frame>;
}
