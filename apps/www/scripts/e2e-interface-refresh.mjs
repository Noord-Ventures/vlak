...
const slugs = (process.env.INTERFACES || "render,drive,orbit,graphics,line,room,wall,evening,press,night,platforms,mobile-os,documentation,music-player,patient,identity,music,agents,microbiology,genome,protein,robotics,circuitry,frontier").split(",");
const failures = [];
