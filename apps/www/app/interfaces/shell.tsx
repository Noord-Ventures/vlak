...
export function InterfaceShell({ slug, children }: { slug: InterfaceSlug; children: ReactNode }) {
  ...
  const workbench = ["microbiology", "genome", "protein", "robotics", "circuitry", "identity", "patient", "music", "render", "drive", "orbit", "line", "press", "wall", "night", "evening", "room", "graphics", "platforms", "mobile-os", "documentation", "music-player", "video-player"].includes(slug);
