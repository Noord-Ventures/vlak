...
export const alt = "iOS interface study, closed and opened iPhone Duo Home screens in Vlak";
...
export default function OpenGraphImage() {
  ...
  return new ImageResponse(
    <div style={{ position: "relative", display: "flex", width: "100%", height: "100%", overflow: "hidden", background: "#faf8f2", color: "#171717", fontFamily: "Inter" }}>
      ...
      <div style={{ position: "absolute", left: 40, top: 88, display: "flex", fontSize: 18, fontWeight: 400, color: "#84817b", letterSpacing: "-0.018em" }}>Interface study</div>
      <div style={{ position: "absolute", left: 40, top: 272, display: "flex", fontSize: 76, fontWeight: 600, letterSpacing: "-0.052em", lineHeight: 1.02 }}>iOS</div>
