...
const styles = stylex.create({
  ...
  groupedSubtle: {
    ...
    borderStartStartRadius: { default: null, ":first-child": 0 },
    borderEndStartRadius: { default: null, ":first-child": 0 },
    borderStartEndRadius: { default: null, ":last-child": 0 },
    borderEndEndRadius: { default: null, ":last-child": 0 },
