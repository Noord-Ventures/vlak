...
export const metadata: Metadata = { title: "Documentation", description: "A quiet documentation index and reader with contents navigation and local reading preferences." };
