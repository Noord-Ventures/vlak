...
try {
  for (const script of ["record-review-ui-e2e.mjs", "workflow-pages-e2e.mjs", "project-tools-e2e.mjs", "reconciliation-e2e.mjs", "creative-export-e2e.mjs", "docs-examples-e2e.mjs", "about-timeline-e2e.mjs"]) {
