...
export const metadata: Metadata = { title: "Music Player", description: "A personal listening room with a 23-track library, individual official previews and local audio playback." };
