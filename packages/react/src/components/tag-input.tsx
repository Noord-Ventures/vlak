...
const styles = stylex.create({
  ...
  remove: {
    ...
    backgroundColor: { default: "transparent", ":hover:not(:disabled):not([aria-disabled='true'])": { default: null, [mq.hover]: vlak.controlFill }, ":disabled": "transparent", [mq.forcedColors]: { default: "ButtonFace", ":hover:not(:disabled):not([aria-disabled='true'])": { default: null, [mq.hover]: "Highlight" }, ":disabled": "ButtonFace" } },
    color: { default: vlak.ink, [mq.forcedColors]: { default: "ButtonText", ":hover:not(:disabled):not([aria-disabled='true'])": { default: null, [mq.hover]: "HighlightText" }, ":disabled": "GrayText" } },
